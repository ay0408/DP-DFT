...
← This assumption is based on that the trend between the elements of the original vector $g$ is expected to be approximately preserved by the operation in steps 2 through 6 of Algorithms 3 and 4, and it would be difficult to distinguish (the sorts in) neighboring datasets from the differences in the probability of each output from our method. Further exploration of this assumption is needed, and depending on the results, our method could be of significant high utility.
...
For details of our mechanisms, please see our paper entitled "Efficient and Highly Accurate Differentially Private Statistical Genomic Analysis using Discrete Fourier Transform" (https://doi.org/10.1109/TrustCom56396.2022.00078) presented at IEEE TrustCom 2022 (IEEE Outstanding Paper Award).
